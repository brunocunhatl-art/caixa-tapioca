...
function App(){
 ...
 return <div className="app">
  ...
  <nav>{[['novo','Novo pedido'],['pedidos','Pedidos'],['cozinha','Tela cozinha'],['financeiro','Financeiro'],['cardapio','Cardápio'],['cupons','Cupons'],['recibo','Configurações']].map(t=><button key={t[0]} className={tab===t[0]?'on':''} onClick={()=>setTab(t[0])}>{t[1]}</button>)}</nav>
